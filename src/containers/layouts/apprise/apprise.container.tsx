...
import { Apprise } from './apprise.component';
...
export class AppriseContainer extends React.Component<NavigationStackScreenProps, State> {
  ...
  private data = routes;
  private navigationKey: string = 'AppriseContainer';
